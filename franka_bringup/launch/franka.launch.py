...
def generate_robot_nodes(context):
    ...
    robot_description = xacro.process_file(
        ...
        mappings={
            ...
            'xyz': LaunchConfiguration('base_xyz').perform(context),
            'rpy': LaunchConfiguration('base_rpy').perform(context),
        },
    ).toprettyxml(indent='  ')
...
def generate_launch_description():
    launch_args = [
	    ...
	    description='Position offset of robot base (x y z)',
	),
	DeclareLaunchArgument(
	    'base_rpy', default_value='0 0 0',
	    description='Rotation offset of robot base (roll pitch yaw)',
	),
    ]
